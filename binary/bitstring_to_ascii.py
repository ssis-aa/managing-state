# Inspired by https://youtu.be/4GWgFZCZn94 

def bitStringToMessage(binary_string):
  # break entire strings into individual byte strings
  separated_bytes = []
  number_of_bytes = round(len(binary_string)/8)
  i = 0
  while(i < number_of_bytes*8):
    separated_bytes.append(binary_string[i:i+8])
    i += 8
  ...
  # put all of the individual characters together 
